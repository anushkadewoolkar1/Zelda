...
public class LinkIdleState : ILinkState
{
    ...
    private void SetIdleSprite()
    {
        ...
        {
            case Direction.Up:
                link.SetSprite(LinkSpriteFactory.Instance.CreateUpWalk(1, 1, link.LinkHurt));
                break;
            case Direction.Down:
                link.SetSprite(LinkSpriteFactory.Instance.CreateDownWalk(1, 1, link.LinkHurt));
                break;
            case Direction.Left:
                link.SetSprite(LinkSpriteFactory.Instance.CreateLeftWalk(1, 1, link.LinkHurt));
                break;
            case Direction.Right:
                link.SetSprite(LinkSpriteFactory.Instance.CreateRightWalk(1, 1, link.LinkHurt));
                break;
        }
    }
}
